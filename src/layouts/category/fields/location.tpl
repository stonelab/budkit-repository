        ...
        <div class="panel-heading" role="tab">
            <h4 class="panel-title">
               ...
               <span class="field-count"><input type="text" tpl:value="${order}" data-toggle="field-count" readonly="readonly" tpl:name="category_form[${order}][order]" /></span>
                ...
                <tpl:condition test="equals" on="type" is="location">
        ...
        <div class="panel-collapse collapse in" role="tabpanel">
            <div class="panel-body">
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                        <select tpl:name="category_form[${order}][location][authority]" class="form-control native">
                ...
                <div class="form-group row">
                    <div class="col-md-8 prn">
                        <input type="text" class="form-control" tpl:name="category_form[${order}][location][name]"  placeholder="Unique short name *" tpl:value="${name}" />
                    </div>
                    <div class="col-md-4">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" tpl:name="category_form[${order}][location][placeholder]" tpl:value="${placeholder}"  placeholder="Placeholder text" />
                </div>
                <div class="form-field-group">
                    <textarea class="form-control" tpl:name="category_form[${order}][location][description]"  placeholder="Description" rows="4"><tpl:data value="description" /></textarea>
                </div>
            </div>
        </div>
    </div>
